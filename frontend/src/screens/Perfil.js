  ...
  return (
    <div className='container loginContenedor'>
        ...
        <Form onSubmit={submit}>
            ...
            <Form.Control type="email" value={name} onChange={(e)=> setName(e.targer.value)}/>
            </Form.Group>

            <Form.Group controlId="email">
            <Form.Label>Email</Form.Label>
            <Form.Control type="email" value={email} onChange={(e)=> setEmail(e.targer.value)}/>
            </Form.Group>

            <Form.Group controlId="password">
            <Form.Label>Password</Form.Label>
            <Form.Control type="password" value={password} onChange={(e)=> setPassword(e.targer.value)}/>
            </Form.Group>
